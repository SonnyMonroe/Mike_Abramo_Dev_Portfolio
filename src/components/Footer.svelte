...
>
	...
	<div class="flex flex-col gap-4 items-center justify-center">
		...
		<p><b class="pr-2">Email</b>mabramo11@protonmail.com</p>
		<p>
			<!-- <b class="pr-2">GitHub</b> -->
			<a href="https://github.com/SonnyMonroe" target="_blank" class="text-violet-400"
				><b class="pr-2">GitHub</b><sup class=""
		...
		<p>
			...
			<a href="https://www.linkedin.com/in/michael-abramo/ " target="_blank" class="text-violet-400"
				><b class="pr-2">LinkedIn</b><sup class=""
					><span class="text-xs scale-75 pl-0.5"
						><i class="fa-solid fa-arrow-up-right-from-square text-xs scale-[75%]" /></span
					></sup
				></a
