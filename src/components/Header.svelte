<script>
	...
	export let tabs = [
		{ name: 'Projects ', link: 'https://aspecta.ai/u/SonnyMonroe' },
		{ name: 'About me', link: '#about' },
		{ name: 'Blog', link: 'https://medium.com/@mabramo11' }
		// { name: "Contact", link: "" },
		// {name: '', link: ''},
	];
</script>
...
<header
	class={'scroll z-[10] top-0 duration-200 px-6 flex items-center justify-between border-b border-solid ' +
